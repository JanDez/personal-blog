...
const defaultSEOConfig = {
  ...
  description: "CSS + JavaScript + TypeScript + Personal blog + NextJS + FrontEnd + ReactJS + Backend + NextJS + Jaifran Hernández + Articles + Programación + Programming + Web Development ",
