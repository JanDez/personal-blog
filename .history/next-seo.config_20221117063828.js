...
const defaultSEOConfig = {
  ...
  description: "HTML + CSS + JavaScript + TypeScript + Personal blog + NextJS + FrontEnd + ReactJS + Backend + NextJS + Jaifran Hernández + Articles + Artículos + Programación + Programming + Web Development + Tutorials + Tutoriales + Rust +Block",
