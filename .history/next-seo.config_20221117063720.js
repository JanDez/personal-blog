...
const defaultSEOConfig = {
  ...
  description: "CSS + JavaScript + TypePersonal blog + NextJS + FrontEnd + ReactJS + Backend + NextJS + Jaifran Hernández + Articles + Programación + Programming + Web Development ",
